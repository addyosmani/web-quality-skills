...
Add JSON-LD to qualify for rich results. The types most sites need are
**Organization**, **Article**, **Product**, **FAQPage**, and **BreadcrumbList** —
ready-to-paste templates for each are in
[references/STRUCTURED-DATA.md](references/STRUCTURED-DATA.md).

Validate any markup with the
...
- [Structured data (JSON-LD) reference](references/STRUCTURED-DATA.md)
