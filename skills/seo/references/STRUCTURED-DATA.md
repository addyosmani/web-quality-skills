...
Copy-paste JSON-LD templates for the schema.org types most pages need. Drop each
inside a `<script type="application/ld+json">` tag in the page's `<head>` or
`<body>`. See the [SEO skill](../SKILL.md#structured-data-json-ld) for when to use them.
